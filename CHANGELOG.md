...
- Rebranded from "GitHub Spec Kit" to "Stampli Core Spec Kit" for internal Stampli/core development
- Updated TAGLINE and description to reflect Stampli Core focus
